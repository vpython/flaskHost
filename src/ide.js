$(function () {
    ...
    var untrusted_origin = '' // if not '', then the origin of the page is not trusted
    ...
    function parseVersionHeader( source ) { // null if sourceLines already exists
        ...
        // 4 entries: 'GlowScript 3.2 VPython nodictionary', 'Web VPython 3.2 nodictionary', 'Web VPython 3.2 wasm'
        ...
        if (elements.length == 2) {
            ...
            if (elements[0] == 'web' && elements[1] == 'vpython') {
                ...
                else if (elements[3] == 'wasm') ret.wasm = true
                else return ret
            }
        }
    ...
    pages.load = async function(route) {
        try {
            ...
            console.log('pages.load catch', err)
            window.console && console.log("Error: ", err)
            alert("There was an error trying to run the program.")
        }
